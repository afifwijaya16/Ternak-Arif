    ...
    <div class="col-md-12">
        <div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Halaman Data Waiting List Proyek</li>
			</ol>
		</div><!--/.row-->
                        ...
                        <tr>
                            ...
                            <td style="width: 190px;" align="center">
                                <div>
                                    ...
                                    <a href="<?php echo base_url();?>Admin/terimaProyek/<?php cetak($b->id_proyek) ?>" class="btn btn-warning btn-xs">Terima</a>
                                </div>
                            </td>
                        </tr>
                        <?php } ?>
